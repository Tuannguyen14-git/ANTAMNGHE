...
{
    public partial class RemoveSensitiveOnDeviceTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "BlockedNumbers");
            migrationBuilder.DropTable(name: "CallHistories");
            migrationBuilder.DropTable(name: "CallLogs");
            migrationBuilder.DropTable(name: "EmergencyContacts");
            migrationBuilder.DropTable(name: "EmergencyKeywords");
            migrationBuilder.DropTable(name: "VipLists");
        }
